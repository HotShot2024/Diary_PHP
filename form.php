...
if (!empty($_POST)) {
    ...
    echo '<a href="index.php">Contiune to the diary</a>';
    die();
}
...
<form method="POST" action="form.php" enctype="multipart/form-data">
    <div class="form-group">
        <label class="from_group-label" for="title">Title:</label>
        <input class="from_group-input" type="text" id="title" name="title" required />
    </div>
    <div class="form-group">
        <label class="from_group-label" for="date">Date:</label>
        <input class="from_group-input" type="date" id="date" name="date" required />
    </div>
    <div class="form-group">
        <label class="from_group-label" for="image">Image:</label>
        <input class="from_group-input" type="file" id="image" name="image" />
    </div>
    <div class="form-group">
        <label class="from_group-label" for="message">Message:</label>
        <textarea class="from_group-input" id="message" name="message" rows="10" required></textarea>
    </div>
